println("Beginning Section 2 Panel IRFs")
...
p2_17 = plot(horizon, irf_values, label="IRF", lw=2, color=:blue, xlabel="Horizon", ylabel="Response", 
...
# Plotting with adjusted y-axis
p2_18 = plot(horizon, irf_values, label="IRF", lw=2, color=:blue, xlabel="Horizon", ylabel="Response", 
...
# Plotting with adjusted y-axis
p2_19 = plot(horizon, irf_values, label="IRF", lw=2, color=:blue, xlabel="Horizon", ylabel="Response", 
...
p2_20 = plot(horizon, irf_values, label="IRF", lw=2, color=:blue, xlabel="Horizon", ylabel="Response", 
     title="Pre-2008", ylim=(y_min, y_max), legend = false)
    plot!(horizon, lower_bound_2, fill_between=(lower_bound_2, upper_bound_2), color=:lightblue, alpha=0.3, label="95% CI")
    plot!(horizon, lower_bound_1, fill_between=(lower_bound_1, upper_bound_1), color=:deepskyblue, alpha=0.2, label="90% CI")
...
################################### Combine Plots ###################################
panel_section2 = plot(p2_17, p2_18, p2_19, p2_20, p2_21, p2_22, layout=(2, 3), size=(1000, 600),bottom_margin=10mm, legend = false)
    savefig(panel_section2, "./output/figure_K.png")

println("Section 2 Panel IRFs Completed")